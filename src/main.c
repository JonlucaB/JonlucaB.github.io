...
build(FILE *f, Lexicon *l, char *name, char *srcpath)
{
	...
	/* header */
	fputs("<header>", f);
	fputs("<a href='home.html'><img src='../media/global/homelogo.svg' alt='" NAME "' height='50'></a><div></div><h1>Jonluca Biagini</h1>", f);
	fputs("</header>", f);
	/* nav */
	fputs("<nav>", f);
	...
	fputs("<footer><hr />", f);
	fpedited(f, srcpath);
	fputs("<b>This website was made possible with code made available by <a href='https://github.com/hundredrabbits/100r.co'>Hundredrabbits</a></b> © 2023 — ", f);
